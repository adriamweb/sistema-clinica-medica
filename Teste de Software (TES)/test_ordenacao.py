...
def test_lista_vazia():
    ...
    resultado = triagem.ordenar_por_prioridade([])
    assert resultado == []
...
def test_um_paciente():
    ...
    resultado = triagem.ordenar_por_prioridade([paciente])
...
def test_ordenacao_por_urgencia():
    ...
    p3 = triagem.Paciente("Crítica", 50, 5)
    p3.timestamp = base_time
    
    resultado = triagem.ordenar_por_prioridade([p1, p2, p3])
...
def test_desempate_por_timestamp():
    ...
    p1 = triagem.Paciente("Primeiro", 30, 3)
    p1.timestamp = base_time
    
    p2 = triagem.Paciente("Segundo", 40, 3)
    p2.timestamp = base_time + timedelta(seconds=1)
    
    resultado = triagem.ordenar_por_prioridade([p2, p1])  # Ordem inversa na entrada
...
def test_ordenacao_complexa():
    ...
    p1 = triagem.Paciente("Urgencia3_Primeiro", 30, 3)
    p1.timestamp = base_time
    
    p2 = triagem.Paciente("Urgencia5", 40, 5)
    p2.timestamp = base_time + timedelta(seconds=1)
    
    p3 = triagem.Paciente("Urgencia3_Segundo", 50, 3)
...
def test_todos_mesma_urgencia():
    ...
    p1 = triagem.Paciente("Primeiro", 30, 2)
    p1.timestamp = base_time
    
    p2 = triagem.Paciente("Segundo", 40, 2)
    p2.timestamp = base_time + timedelta(seconds=1)
    
    p3 = triagem.Paciente("Terceiro", 50, 2)
    p3.timestamp = base_time + timedelta(seconds=2)
    
    resultado = triagem.ordenar_por_prioridade([p3, p1, p2])  # Ordem aleatória
